...
include_once("header.php"); ?>
        ...
        <main>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 text-center mx-auto">
                            <div class="hero-section-text">
                                <small class="section-small-title"><?php echo get_field('welcome_text'); ?> <i class="hero-icon bi-house"></i></small>

                                <h1 class="hero-title text-white mt-2 mb-4"><?php echo get_field('banner_title'); ?></h1>
                                        ...
                                        <div class="col-lg-5 col-md-6 col-12">
                                            <div class="input-group align-items-center">
                                                ...
                                                <select name="price-range" class="form-select form-control" id="price-range" aria-label="Default select example">
                                                    ...
                                                    <option value="1000">$1,000 - 200</option>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-5 col-12">
                            <small class="section-small-title"><?php echo get_field('section_title'); ?></small>

                            <h2 class="mt-2 mb-4"><span class="text-muted"><?php echo get_field('section_titles'); ?></h2>

                            <h4 class="text-muted mb-3"><?php echo get_field('test_desc'); ?></h4>

                            <p><?php echo get_field('text_description'); ?></p>
                        </div>

                        <div class="col-lg-3 col-md-5 col-5 mx-lg-auto">
                       
                      <img src="<?php echo the_field ('small_image'); ?>" class="about-image about-image-small img-fluid" alt="">
                        </div>

                        <div class="col-lg-4 col-md-7 col-7">
                            <img src="<?php echo the_field ('big_image'); ?>" class="about-image img-fluid" alt="">
                        </div>
                    ...
                    <div class="row">
                            ...
                            <div class="shop-thumb">
                                <div class="shop-image-wrap">
                                    <a href="shop-detail.html">
                                        <img src="<?php echo get_template_directory_uri();?>/images/shop/minimal-bathroom-interior-design-with-wooden-furniture.jpg" class="shop-image img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="shop-thumb">
                                <div class="shop-image-wrap">
                                    <a href="shop-detail.html">
                                        <img src="<?php echo get_template_directory_uri();?>/images/shop/mock-up-poster-modern-dining-room-interior-design-with-white-empty-wall.jpg" class="shop-image img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="shop-thumb">
                                <div class="shop-image-wrap">
                                    <a href="shop-detail.html">
                                        <img src="<?php echo get_template_directory_uri();?>/images/shop/green-sofa-white-living-room-with-blank-table-mockup.jpg" class="shop-image img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="shop-thumb">
                                <div class="shop-image-wrap">
                                    <a href="shop-detail.html">
                                        <img src="<?php echo get_template_directory_uri();?>/images/shop/concept-home-cooking-with-female-chef.jpg" class="shop-image img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="shop-thumb">
                                <div class="shop-image-wrap">
                                    <a href="shop-detail.html">
                                        <img src="<?php echo get_template_directory_uri();?>/images/shop/childrens-bed-nursery-cot-velvet-childrens-room.jpg" class="shop-image img-fluid" alt="">
                                    </a>
                            ...
                            <div class="owl-carousel reviews-carousel">
                                <div class="reviews-thumb">
                                    ...
                                    <div class="reviews-bottom reviews-bottom-up d-flex align-items-center">
                                        <img src="<?php echo get_template_directory_uri();?>/images/avatar/pretty-blonde-woman-wearing-white-t-shirt.jpg" class="avatar-image img-fluid" alt="">
                                ...
                                <div class="reviews-thumb">
                                    ...
                                    <div class="reviews-bottom reviews-bottom-up d-flex align-items-center">
                                        <img src="<?php echo get_template_directory_uri();?>/images/avatar/studio-portrait-emotional-happy-funny-smiling-boyfriend-man-with-heavy-beard-stands-with-arms-crossed-dressed-red-t-shirt-isolated-blue.jpg" class="avatar-image img-fluid" alt="">
                                ...
                                <div class="reviews-thumb">
                                    ...
                                    <div class="reviews-bottom reviews-bottom-up d-flex align-items-center">
                                        <img src="<?php echo get_template_directory_uri();?>/images/avatar/portrait-beautiful-young-woman-standing-grey-wall.jpg" class="avatar-image img-fluid" alt="">
                                ...
                                <div class="reviews-thumb">
                                    ...
                                    <div class="reviews-bottom reviews-bottom-up d-flex align-items-center">
                                        <img src="<?php echo get_template_directory_uri();?>/images/avatar/portrait-young-redhead-bearded-male-wears-white-t-shirt-keeps-his-eyes-closed-smiling-feels-happy-yellow.jpg" class="avatar-image img-fluid" alt="">
                                ...
                                <div class="reviews-thumb">
                                    ...
                                    <div class="reviews-bottom reviews-bottom-up d-flex align-items-center">
                                        <img src="<?php echo get_template_directory_uri();?>/images/avatar/portrait-young-beautiful-woman-gesticulating.jpg" class="avatar-image img-fluid" alt="">
            ...
            <section class="contact-section" id="section_5">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#f9f9f9" fill-opacity="1" d="M06L40,117.3C80,139,160,181,240,186.7C320,192,400,160,480,149.3C560,139,640,149,720,176C800,203,880,24560,250.7C1040,256,1120,224,1200,229.3C1280,235,1360,277,1400,298.7L1440,320L1440,0L1400,0C1360,0,1280,0,1200,0C1120,0,1040,060,0C880,0,800,0,720,0C640,0,560,0,480,0C400,0,320,0,240,0C160,0,80,0,40,0L0,0Z"></path></svg>
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <form class="custom-form contact-form" action="#" method="post" role="form">
                                <div class="row">
                                    ...
                                    <?php echo do_shortcode('[custom_user_forms]'); ?>
                                </div>
</div>
                            </form>
                        </div>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#36363e" fill-opacity="1" d="M06L40,117.3C80,139,160,181,240,186.7C320,192,400,160,480,149.3C560,139,640,149,720,176C800,203,880,24560,250.7C1040,256,1120,224,1200,229.3C1280,235,1360,277,1400,298.7L1440,320L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,32060,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path></svg>            
        </main>
